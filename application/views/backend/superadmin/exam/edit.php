...
<?php foreach($exams as $exam){ ?>
  <form method="POST" class="d-block ajaxForm" action="<?php echo route('exam/update/'.$param1); ?>">
    ...
    <div class="form-row">
      ...
      <div class="form-group mb-1">
        <label for="starting_date"><?php echo get_phrase('starting_date'); ?><span class="required"> * </span></label>
      ...
      <div class="form-group mb-1">
        <label for="ending_date"><?php echo get_phrase('ending_date'); ?><span class="required"> * </span></label>
      ...
      <div class="form-group  col-md-12">
        <button class="btn btn-primary btn-l px-4 " id="update-btn" type="submit"><i class="mdi mdi-account-check"></i><?php echo get_phrase('create_exam'); ?></button>
      </div>
    </div>
  </form>
<?php } ?>
