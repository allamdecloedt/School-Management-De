                        ...
                        <div class="form-group row mb-3">
                                ...
                                <div class="col-md-5 logo-upload-container">
                                        <div class="logo-card">
                                            ...
                                            <div class="logo-preview" id="profile_image-preview">
                                                    <img src="<?php echo $this->user_model->get_user_image($this->session->userdata('user_id')). '?v=' . time(); ?>" alt="Mentor Profile Image" class="preview-image">
                                            ...
                                            <div class="logo-upload-btn">
                                                ...
                                                <input id="profile_image" type="file" class="image-upload" name="profile_image" accept="image/*" data-preview="profile_image-preview">
                                            </div>
                                        </div>
                                </div>
                            </div>
