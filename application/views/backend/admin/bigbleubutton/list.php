...
$rooms = $this->db->get_where('rooms', array('school_id' => $school_id))->result_array();
...
<div class="container mt-4">
    ...
    <input type="text" class="form-control w-25" placeholder="🔍 Search">
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createRoomModal">+ New Room</button>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createRoomModalLabel">Créer une nouvelle salle</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="createRoomForm">
                    <div class="mb-3">
                        <label for="meetingName" class="form-label">Nom de la réunion</label>
                    ...
                    <button type="submit" class="btn btn-success w-100">Créer la salle</button>
                </form>
            </div>
        </div>
    </div>
