...
<form method="POST" class="d-block ajaxForm" action="<?php echo route('class_room/update/'.$param1); ?>">
    ...
    <div class="form-row">
        <div class="form-group mb-1">
            <label for="name"><?php echo get_phrase('class_room_name'); ?><span class="required"> * </span></label>
        ...
        <div class="form-group  col-md-12">
            <button class="btn btn-primary btn-l px-4" id="update-btn" type="submit"><i class="mdi mdi-account-check"></i><?php echo get_phrase('update_class_room'); ?></button>
        </div>
    </div>
</form>
<?php } ?>
